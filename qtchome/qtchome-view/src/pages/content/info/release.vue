  ...
  export default {
    ...
    mounted: function () {
      this.$nextTick(function () {
        this.$store.dispatch('Get', {'url': '/api-home/frontPage/courseType/getCourseTypeList'}).then(res => {
        ...
        if (courseId != null) {
          ...
          this.$store.dispatch('Get', {'url': '/api-home/frontPage/course/getCourseDetail/' + courseId}).then(res => {
    ...
    methods: {
      ...
      beforeAvatarUpload (file) {
        ...
        let fd = new FormData()
        fd.append('file', file)
        this.$store.dispatch('Post', {'url': '/api-home/frontPage/file/upload', 'data': fd}).then(res => {
